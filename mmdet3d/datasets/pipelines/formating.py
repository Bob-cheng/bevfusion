...
class DefaultFormatBundle_v2(object):
...
@PIPELINES.register_module()
class DefaultFormatBundle3D_v2(DefaultFormatBundle_v2):
    """Default formatting bundle.
    ...
    def __init__(self, class_names, with_gt=True, with_label=True):
        super(DefaultFormatBundle3D_v2, self).__init__()
                ...
                if 'gt_names_3d' in results:
                    results['gt_labels_3d'] = np.array([
                        ...
                        for n in results['gt_names_3d']
                                                       ...
                                                       dtype=np.int64)
        results = super(DefaultFormatBundle3D_v2, self).__call__(results)
        return results
