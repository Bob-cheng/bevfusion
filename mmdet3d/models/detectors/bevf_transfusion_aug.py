...
class BEVF_TransFusion_Aug(BEVF_FasterRCNN_Aug):
    ...
    def init_weights(self, pretrained=None):
        ...
        # super(BEVF_TransFusion_Aug, self).init_weights(pretrained)
        # for param in self.parameters():
        #     if param.data.dtype is torch.int64:
        #         param.data = param.data.float()

        # assert pretrained is None
        # super(BEVF_TransFusion_Aug, self).init_weights()
    ...
    def simple_test(self, points, img_metas, img=None, img_aug_matrix=None, rescale=False, **kwargs):
